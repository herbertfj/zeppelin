...
export ZEPPELIN_JAVA_OPTS="-Dspark.jars=/home/ubuntu/dev/omegapoint/opr-spark/target/scala-2.10/opr-spark-0.1-SNAPSHOT.jar"      # Additional jvm options. for example, export ZEPPELIN_JAVA_OPTS="-Dspark.executor.memory=8g -Dspark.cores.max=16"
